...
<html>
 ...
 <body>
		...
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ljCmsContentAuditController.do?doSortList" >
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr><span style="color: red;font-size:14px;" >需要修改的排序(如果序号已存在，则覆盖之前的排序)</span></tr>
				<tr>
					<td align="center">
						<label class="Validform_label">
							排序
					...
					<td class="value">
						<input class="inputxt" id="sort" name="sort" datatype="/^([1-9]|10)$/g" placeholder="请输入排序号，1-10" errormsg="只能输入1-10之间的数字!" />
